...
import { BookOpen, FlaskConical, Handshake, Pickaxe, Swords, type LucideIcon } from 'lucide-react';
...
export const PORTALS: PortalDef[] = [
  ...
  { id: 'arena', name: 'ארנה החשיבה', emoji: '♟️', icon: Swords, color: '#3E6BF0', dark: '#1F3FA8', angle: 0.35, open: true },
];
